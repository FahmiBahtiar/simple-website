         ...
         <form action="registerController.php" method="post">
               <div class="page slide-page">
                  ...
                  <div class="field">
                     ...
                     <input type="text" class="form-control" name="firstName" max="15" required>                  </div>
                  <div class="field">
                     <div class="label">
                        Last Name
                     </div>
               ...
               <div class="page">
                  ...
                  <div class="field">
                     ...
                     <input type="text" class="form-control" name="username" max="15" required>                  </div>
                  <div class="field">
                     <div class="label">
                        Password
                     </div>
                     <input type="password" class="form-control" name="password" max="15" required>                  </div>
                  <div class="field btns">
