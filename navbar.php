...
<body >
    <div class="home-section-navbar"   style="background-color: black">
        ...
        <nav class="navbar">
            <div class="nav-container">
                ...
                <ul class="nav-links">
                    <!-- NAVIGATION MENUS -->
                    <div class="menu">
                        <li><a href="../../Simple Website/">Home</a></li>
                        <?php if ($loggedin) : ?>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" style="background-color: #F3AF34;">
                                    <a class="dropdown-item" href="listArticle.php">List All Article</a>
                                    <a class="dropdown-item" href="listAuthor.php">List All Author</a>
                                    <a class="dropdown-item" href="listCategories.php">List All Category</a>
                                </div>
                            </div>
                            <li><a href="mainArticle.php">Article</a></li>
